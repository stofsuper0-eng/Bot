...
class EmoteBot(BaseBot):
    ...
    def __init__(self):
        ...
        self._tasks            = set()  # ✅ FIXED: Track all tasks
    ...
    # ✅ FIXED: Added create_task method
    ...
    # ✅ FIXED: Added on_user_leave handler
    ...
    # ✅ FIXED: Added on_user_move handler
    ...
    async def on_start(self, session_metadata: SessionMetadata) -> None:
        ...
        # ✅ FIXED: Use create_task method instead of asyncio.create_task
    ...
    # ✅ FIXED: Complete error handler wrapper
    async def on_chat(self, user: User, message: str):
        """Handle chat messages with full error protection."""
        try:
    ...
    async def _room_cache_updater(self):
        """✅ FIXED: Update room cache with proper error handling."""
        try:
            while self.is_connected:
                try:
                    try:
    ...
    # ✅ FIXED: Complete on_disconnect with proper cleanup
    async def on_disconnect(self) -> None:
        """Called when bot disconnects. Clean everything up."""
        self.is_connected = False
        self._room_cache = []
